...
const file_proto_order_proto_rawDesc = "" +
	"\n" +
	"\x11proto/order.proto\x12\border.v1\"E\n" +
	...
	"\x06status\x18\x04 \x01(\tR\x06status2\xe6\x01\n" +
	"\fOrderService\x12J\n" +
	...
	"\n" +
	"ListOrders\x12\x1b.order.v1.ListOrdersRequest\x1a\x1c.order.v1.ListOrdersResponseBEZCgitlab.com/4uvirik/my-platform/services/order-service/proto;orderpbb\x06proto3"
...
var file_proto_order_proto_depIdxs = []int32{
	6, // 0: order.v1.GetOrderResponse.order:type_name -> order.v1.Order
	6, // 1: order.v1.ListOrdersResponse.orders:type_name -> order.v1.Order
	...
	4, // 4: order.v1.OrderService.ListOrders:input_type -> order.v1.ListOrdersRequest
	...
	5, // 7: order.v1.OrderService.ListOrders:output_type -> order.v1.ListOrdersResponse
